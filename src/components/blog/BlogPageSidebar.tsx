...
export default function BlogPageSidebar({ variant, futurePosts = [] }: BlogPageSidebarProps) {
  if (variant === 'future') {
    return (
      <aside className="space-y-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded text-sm focus:outline-none focus:border-brand-blue"
          />
        </div>
        <div>
          <h3 className="font-bold text-gray-900 mb-4">Future Trading</h3>
